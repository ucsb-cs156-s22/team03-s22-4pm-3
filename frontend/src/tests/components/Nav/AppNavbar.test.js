...
describe("AppNavbar tests", () => {
  ...
  test("renders the articles menu correctly for an admin", async () => {
    ...
    await waitFor(() =>
      expect(getByTestId("appnavbar-articles-dropdown")).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-articles-list/)).toBeInTheDocument()
    );
  });
  ...
  test("renders the reviews menu correctly for an admin", async () => {
    ...
    await waitFor(() =>
      expect(getByTestId("appnavbar-reviews-dropdown")).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-reviews-list/)).toBeInTheDocument()
    );
  });
  ...
  test("renders the menuItem menu correctly for an admin", async () => {
    ...
    await waitFor(() =>
      expect(getByTestId("appnavbar-menu-item-dropdown")).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-menu-item-list/)).toBeInTheDocument()
    );
  });
