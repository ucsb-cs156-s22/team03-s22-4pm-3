        ...
        <Container>
          ...
          <Navbar.Collapse>
            ...
            <Nav className="me-auto">
              ...
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="UCSB Dining Commons Menu Item" id="menu-item-dropdown" data-testid="menu-item-dropdown" >
                    <NavDropdown.Item as={Link} to="/menuitem/list" data-testid="menu-item-list">List Menu Items</NavDropdown.Item>
                  </NavDropdown>
                )
              }
