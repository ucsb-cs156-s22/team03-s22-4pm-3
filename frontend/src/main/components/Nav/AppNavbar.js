...

              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Recommendation" id="appnavbar-recommendation-dropdown" data-testid="appnavbar-recommendation-dropdown" >
                    <NavDropdown.Item as={Link} to="/recommendation/list">List Todos</NavDropdown.Item>
                    <NavDropdown.Item as={Link} to="/recommendation/create">Create Todo</NavDropdown.Item>
                  </NavDropdown>
                )
              }
